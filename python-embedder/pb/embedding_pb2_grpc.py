...
class EmbedderStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Embed = channel.unary_unary(
                ...
                response_deserializer=embedding__pb2.VectorResponse.FromString,
...
def add_EmbedderServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Embed': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=embedding__pb2.VectorResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'embeds.Embedder', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('embeds.Embedder', rpc_method_handlers)
...
class Embedder(object):
    ...
    def Embed(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            embedding__pb2.VectorResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
