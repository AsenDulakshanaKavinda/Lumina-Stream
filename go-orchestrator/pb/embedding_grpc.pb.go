...
const (
	Embedder_Embed_FullMethodName = "/embeds.Embedder/Embed"
)
...
type EmbedderClient interface {
	Embed(ctx context.Context, in *TextRequest, opts ...grpc.CallOption) (*VectorResponse, error)
}
...
func (c *embedderClient) Embed(ctx context.Context, in *TextRequest, opts ...grpc.CallOption) (*VectorResponse, error) {
...
type EmbedderServer interface {
	Embed(context.Context, *TextRequest) (*VectorResponse, error)
...
func (UnimplementedEmbedderServer) Embed(context.Context, *TextRequest) (*VectorResponse, error) {
...
func _Embedder_Embed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbedderServer).Embed(ctx, req.(*TextRequest))
	}
